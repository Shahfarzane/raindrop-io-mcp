...
export default function generateTags({
	...
	sections.push("\n## Guidelines");
	sections.push(
		"1. **Prefer existing tags** from user's vocabulary for consistency",
	);
	sections.push(
		"2. **Use lowercase, hyphenated format** (e.g., 'machine-learning' not 'Machine Learning')",
	);
	...
	sections.push(
		"4. **Consider Raindrop's suggestions** but don't blindly accept them",
	);
	sections.push(
		"5. **Be specific** - 'react-hooks' is better than just 'react'",
	);
