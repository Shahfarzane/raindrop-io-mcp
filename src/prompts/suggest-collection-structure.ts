...
export default function suggestCollectionStructure({
	...
	sections.push("");
	sections.push(
		"1. **Create logical parent categories** that group related tags",
	);
	sections.push(
		"   - Example: 'Design' parent with 'UI', 'Animation', 'Portfolio' children",
	);
	sections.push(
		"   - Example: 'AI & Tech' parent with 'AI', 'Agents', 'Tools' children",
	);
	sections.push("");
	sections.push(
		"2. **Keep hierarchy shallow** - max 2 levels (parent → child)",
	);
	sections.push("");
	sections.push("3. **Group by user intent**, not just tag similarity:");
	sections.push(
		"   - 'Shopping' + 'Fashion' + 'Clothing' → 'Shopping & Style'",
	);
	sections.push(
		"   - 'Tools' + 'Components' → could go under 'Development Resources'",
	);
	sections.push("");
	sections.push("4. **Consider these common parent categories:**");
	sections.push(
		"   - Design & Creative (design, ui, animation, portfolio, creative)",
	);
	sections.push("   - AI & Technology (ai, agents, tools)");
	sections.push("   - Development (tools, components, code)");
	sections.push(
		"   - Shopping & Lifestyle (shopping, fashion, home, clothing)",
	);
	sections.push("   - Reading & Reference (article, documentation)");
	sections.push("");
	sections.push(
		"5. **Map tags to collections** - specify which tags go into each collection",
	);
	...
	sections.push("");
	sections.push(
		"Return a JSON structure ready for the `create_collection_hierarchy` tool:",
	);
	sections.push("```json");
	sections.push("{");
	...
	sections.push(
		'      "tags": ["design", "ui", "animation", "creative", "portfolio"],',
	);
	sections.push('      "children": [');
	sections.push(
		'        { "name": "UI Components", "tags": ["ui", "components"] },',
	);
	sections.push(
		'        { "name": "Portfolios & Studios", "tags": ["portfolio", "studio"] }',
	);
	sections.push("      ]");
	sections.push("    },");
	sections.push("    {");
	...
	sections.push("**Notes:**");
	sections.push(
		"- `tags` array lists which tags should be moved to that collection",
	);
	sections.push("- `children` can be empty if no sub-collections needed");
	sections.push(
		"- A tag can appear in both parent and child (child takes precedence)",
	);
